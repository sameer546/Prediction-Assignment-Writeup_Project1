# Prediction-Assignment-Writeup_Project1
Prediction Project1
The below document describes the analysis for the prediction assignment from the Project Course of Practical Machine Learning.
